...
const joinUs = () => {
	return (
		<div className="relative w-full lg:h-[925px] h-[550px] mt-[32px] pb-[64px]">
			...
			<div className="absolute inset-0 flex flex-col items-center justify-center">
				...
				<Link to="/signup">
					<button className="text-[#375761] bg-white rounded-[100px] p-2 px-5 drop-shadow-lg hover:scale-105" >
						Sign Up Now!
					</button>
				</Link>
			</div>
