...
function FilterComponent ({ items , category , location }){
	...
	return(
		<div>
			<div className="lg:max-w-[890px] mx-auto pt-1.5">
				<div 
					className="lg:max-w-[103px] h-[51px] bg-white border flex items-center justify-center cursor-pointer rounded-md text-lg z-10  border-[#7CD1EB]"
					onClick={handleModel}
				>
