        ...
        <div className='flex justify-center'>
            <div className='container'>
                <div className='image-container'>
                    <img className='image' src={image} alt={imageAlt || title} />
                </div>
                <div className='content-container-large content-container-small'>
                        ...
                        <div className='utility-container'>
                            {workDetails.map(({ icon, linkKey }, index) => (
                                <div key={index} className='work-detail-item'>
                                    ...
                                    {index !== 2 
                                        ? <p className='utility-item utility-border'>{linkKey}</p>
                                        : <p className='utility-item'>{linkKey}</p>
                                    }
                                </div>
                            ))}
                        </div>
                    </div>
                    <div className='body-container-large body-container-small'>
                        ...
                        <div className='footer-container'>
                            ...
                            <div className='flex justify-between'>
                                ...
                                <Link to={`/company/companydetail/${companyUrl}`} className='read-more-link'>
